...
/**
  ...
  *
  * @checksum - 9e9a693e0a90bac03b37e88a1926992b0f886338a947898e6658c76080f82bcb
  * @variables - radius=rounded-xl,accentColor=blue,colorTemperature=slate,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
