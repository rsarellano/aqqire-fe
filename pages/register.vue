<template>
  <div class="flex flex-col w-full max-w-md gap-2">
    <h1 class="my-4 text-2xl font-bold">Create your account</h1>
    <FormKit type="email" label="Email Address" />
    <FormKit type="text" label="First Name" />
    <FormKit type="text" label="Last Name" />
    ...
    <NuxtLink
      to="/login"
      class="underline underline-offset-2 text-slate-900">
