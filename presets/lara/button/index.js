export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      {
        "text-primary-500 border border-primary-500 hover:bg-blue-300/20":
      ...
      {
        "text-green-500 border border-green-500 hover:bg-blue-300/20":
      ...
      // Primary
      {
        "hover:bg-blue-600 dark:hover:bg-blue-300 hover:border-primary-600 dark:hover:border-primary-300":
          !props.link &&
          props.severity === null &&
          !props.text &&
          !props.outlined &&
      ...
      // Success
      {
        "hover:bg-blue-600 dark:hover:bg-blue-300 hover:border-green-600 dark:hover:border-green-300":
          props.severity === "success" &&
          !props.text &&
          !props.outlined &&
          !props.plain,
