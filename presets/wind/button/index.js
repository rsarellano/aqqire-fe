export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            // Success Button
            {
                'text-white dark:text-blue-900': props.severity === 'success' && !props.text && !props.outlined && !props.plain,
                'bg-blue-500 dark:bg-blue-400': props.severity === 'success' && !props.text && !props.outlined && !props.plain,
                'ring-1 ring-blue-500 dark:ring-blue-400': props.severity === 'success' && !props.text && !props.outlined && !props.plain
            },
            // Success Text Button
            { 'text-blue-500 dark:text-blue-400': props.text && props.severity === 'success' && !props.plain },
            // Success Outlined Button
            { 'text-blue-500 ring-1 ring-blue-500 hover:bg-blue-300/20': props.outlined && props.severity === 'success' && !props.plain },
            ...
            // Success
            { 'hover:bg-blue-600 dark:hover:bg-blue-300 hover:ring-blue-600 dark:hover:ring-blue-300': props.severity === 'success' && !props.text && !props.outlined && !props.plain },
            { 'focus:ring-blue-500 dark:focus:ring-blue-400': props.severity === 'success' },
            // Text & Outlined Button
            { 'hover:bg-blue-300/20': (props.text || props.outlined) && props.severity === 'success' && !props.plain },
